...
- [x] 1. Banco de pruebas para el hook, ANTES de tocarlo. Monta tres repos temporales —uno
...
- [x] 2. El digest nombra el repositorio del que habla. Es la línea que convierte una
      afirmación falsa sobre el trabajo en una afirmación cierta sobre otro repo.

- [x] 3. Separar «no usa OpenSpec» de «lo usa y no hay cambio activo». La orden
      `/opsx:propose` solo sale en el segundo caso.

- [x] 4. El caché sale del repositorio observado: a un directorio del usuario, con el
...
- [x] 5. El hook deja de crear nada dentro de un repositorio que no da señales del kit.
