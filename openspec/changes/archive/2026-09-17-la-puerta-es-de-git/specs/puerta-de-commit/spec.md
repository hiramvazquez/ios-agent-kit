...
**Reason**: La puerta deja de analizar la invocación. Un hook de git corre en el repositorio
del commit sin tener que deducirlo, y cubre las formas que el analizador no cubría ni podía
cubrir sin reescribir un lexer de shell.
